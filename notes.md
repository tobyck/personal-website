...
All of the following information only applies to right angled triangles. The longest side of a triangle is called the hypotenuse (h), the side oposite to an angle marked (often the smaller one) is called the opposite side (o), and the side adjacent to the angle is called the adjacent side (a). An acronym to remember trigonometric functions is SOHCAHTOA — <span>sinθ = o/a</span>, <span>cosθ = a/h</span>, and <span>tanθ = o/a</span>. These eqautions can easily be rearranged to solve for θ, or any side length. Some examples are below:

To calculate the angle of a tringle with o = 3, a = 4, and h = 5, you can use any function because all of the side lengths are known. Say you use sine. You can rearrange <span>sinθ = o/h</span> to say that <span>θ = arcsin(o/h)</span>, by taking the arcsin (or <span>sin<sup>-1</sup></span>) of each side. Therefore, <span>θ = arcsin(3/5) ≈ 36°</span>

Now say you have the triangle a = 7, and θ = 30°, that's all you know. To find the side thength of o, you would rearrange <span>tanθ = o/a</span> to <span>a tanθ = o</span> by multiplyimg both sides of the equation by <span>a</span>. If you plug in the numbers, you get <span>o = a tan30 = 40.4 (2dp)</span>  <br><br>
